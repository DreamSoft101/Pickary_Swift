...
class CameraMan {
  ...
  func switchCamera(_ completion: (() -> Void)? = nil) {
    ...
    func takePhoto(_ previewLayer: AVCaptureVideoPreviewLayer, location: CLLocation?, completion: ((_ image: UIImage?) -> Void)? = nil) {
...
//        self.savePhoto(image, location: location, completion: completion)
    ...
    func savePhoto(_ image: UIImage, location: CLLocation?, completion: ((_ img: UIImage?) -> Void)? = nil) {
